...
export function Education() {
  const { t } = useLanguage()
  const titleRef = useGSAPScrollReveal<HTMLHeadingElement>({ direction: 'up', duration: 0.7, start: 'top 88%' })
  const cardRef = useGSAPScrollReveal<HTMLDivElement>({ direction: 'right', distance: 60, duration: 1.0, start: 'top 82%' })
